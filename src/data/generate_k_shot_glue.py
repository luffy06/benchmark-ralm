...
def main():
    ...
    parser.add_argument("--task", type=str, nargs="+", 
        default=['MRPC', 'MNLI', 'CoLA', 'SST-2', 'STS-B', 'QQP', 'QNLI', 'RTE', 'WNLI', 'SNLI', 'mr', 'sst-5', 'subj', 'trec', 'cr', 'mpqa'],
        help="Task names")
    ...
    parser.add_argument("--mode", type=str, default='k-shot', choices=['k-shot', 'k-shot-10x', 'full-set'], help="k-shot or k-shot-10x (10x dev set) or all data for fine-tuning") 

    args = parser.parse_args()
    if args.mode == 'full-set':
        args.k = 0
    if args.k == 0:
        args.mode = 'full-set'
        args.seed = [0]
