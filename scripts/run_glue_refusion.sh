...
do
    ...
    do
        ...
        LOG_DIR=$PROJECT_DIR/results/glue/$MODEL_NAME-refusion/$TASK
        ...
        LOCAL_RANK=0,1 CUDA_VISIBLE_DEVICES=$DEVICE \
            python -m torch.distributed.launch \
                ...
                --learning_rate $LR \
                --learning_rate_bilevel $LR_BILEVEL \
                --max_steps $MAX_STEP \
                ...
                --fusion_strategy 'search' \
                --search_candidates 'identity' 'mask_add_cls' 'ordered_mask_add_cls' \
                --retrieve_texts \
                $TASK_EXTRA \
